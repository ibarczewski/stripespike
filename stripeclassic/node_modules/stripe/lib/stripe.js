...
const resources = require('stripe/lib/resources');
...
Stripe.PACKAGE_VERSION = require('stripe/package.json').version;
...
Stripe.StripeResource = require('stripe/lib/StripeResource');
...
function Stripe(key, config = {}) {
  ...
  this.errors = require('stripe/lib/Error');
  this.webhooks = require('stripe/lib/Webhooks');

  this._prevRequestMetrics = [];
  this.setTelemetryEnabled(props.telemetry !== false);
}

Stripe.errors = require('stripe/lib/Error');
Stripe.webhooks = require('stripe/lib/Webhooks');
